  ...
  return (
    <footer className="w-full border-t bg-gray-50 mt-20">
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        {/* Brand */}
        <div>
          <h3 className="text-xl font-bold">Sistem Perpustakaan</h3>
          ...
          <div className="flex gap-4 mt-4">
            ...
            {/* Instagram */}
            <a
              href="https://instagram.com/kyardynn"
              target="_blank"
            ...
            {/* Twitter */}
            <a
              href="https://twitter.com/LynxxZuraa"
              target="_blank"
              className="text-slate-600 hover:text-primary transition"
            >
              <span>
            ...
            {/* Facebook */}
            <a
              href="https://facebook.com/boyahh.nob"
              target="_blank"
              className="text-slate-600 hover:text-primary transition"
            >
              <span>
